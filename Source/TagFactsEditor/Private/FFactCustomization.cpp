...
TSharedRef<IPropertyTypeCustomization> FFactCustomization::MakeInstance()
{
	return MakeShareable(new FFactCustomization());
}

void FFactCustomization::CustomizeHeader(TSharedRef<IPropertyHandle> InStructPropertyHandle,
...
void FFactCustomization::CustomizeChildren(TSharedRef<IPropertyHandle> InStructPropertyHandle,
	IDetailChildrenBuilder& StructBuilder, IPropertyTypeCustomizationUtils& StructCustomizationUtils)
{
	TSharedPtr<IPropertyHandle> TagHandle = InStructPropertyHandle->GetChildHandle(GET_MEMBER_NAME_CHECKED(FFact, Tag));
	TSharedPtr<IPropertyHandle> ValueHandle = InStructPropertyHandle->GetChildHandle(GET_MEMBER_NAME_CHECKED(FFact, Value));
